...
import { useTddVulnerabilities } from "#api";
...
const Vulnerabilities = () => {
	...
	const { data = {}, isLoading } = useTddVulnerabilities(internalId, token);
	const vulnerabilitiesInfo = useMemo(() => data.vulnerabilities, [data]);
