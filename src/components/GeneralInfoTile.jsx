...
const Tile = (props) => {
	...
	const { number, title, tooltip, adornment, redirectTo, content = "default content", row = 1, percent = false, isTime = false, added = null, removed = null } = props;

	const diffSection = ((added || removed) ? (
		<Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", width: "100%" }} >
			{added !== null && (
				<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
					...
					(+{formatTileNumber(added, { percent, isTime })})
					</Typography>
				</Box>
			)}
			{removed !== null && (
